...
"""
    for running: python search.py -d <dictionary-file> -p <postings-file> -q <file-of-queries> -o <output-file-of-results>
"""
...
"""
infix to postfix notation , the shunting yard algorithm
params:
